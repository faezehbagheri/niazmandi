...
{{--                    <li onclick="show_area('area','{{ $value2->id }}','{{ sizeof($value2->getAreaFormShahr) }}','{{ $value2->shahr_name }}')">--}}
{{--                        <span>{{ $value2->shahr_name }}</span>--}}
{{--                        @if(sizeof($value2->getAreaFormShahr)>0)--}}
{{--                            <span class="fa fa-angle-left"></span>--}}
{{--                        @endif--}}
{{--                    </li>--}}
{{--                @endforeach--}}
...
{{--                    @foreach($value2->getAreaFormShahr as $key3=>$value3)--}}
